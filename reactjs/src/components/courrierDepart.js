...
export default function CourrierDepart() {
    ...
    let currentMails = filteredlists.slice(indexOfFirstMail, indexOfLastMail);
                    ...
                    <table>
                        ...
                        {currentMails.map((mail, index) => (
                            <tr key={index}>
                                ...
                                <td>{mail.intérêt} </td>
                                <td>{mail.employe}</td>
                                <td className="text-center"><label className="badge rounded-pill text-bg-dark "></label>{mail.type_courriel}
                                </td>
                                {mail.type_courriel === "travail effectué" ? (
                                    <>
                                        <td className="text-center">{mail.datec}</td>
                                        <td className="text-center">{mail.datep}</td>
                                    </>
                                ) : (
                                    <>
